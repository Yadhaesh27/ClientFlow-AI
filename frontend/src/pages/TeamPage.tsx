...
const INITIAL_TEAM: TeamMember[] = [
  ...
  },
  {
    ...
    email: 'marcus@clientflow.demo',
    skills: ['Python', 'Docker', 'Kubernetes', 'GCP'],
    projects: 2,
    tasks: 5,
    workload: 55,
    status: 'ACTIVE',
  ...
  },
  {
    ...
    skills: ['Agile Sprint Planning', 'Jira', 'Client SLA Management'],
    projects: 5,
    tasks: 5,
    workload: 70,
    status: 'ACTIVE',
  ...
  },
  {
    ...
    skills: ['Resource Allocation', 'System Architecture', 'Financial Auditing'],
    projects: 5,
    tasks: 5,
    workload: 50,
    status: 'ACTIVE',
